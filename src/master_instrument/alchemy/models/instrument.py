...
class Instrument(Base):
    ...
    entity_id: Mapped[int] = mapped_column(ForeignKey("master.entity.entity_id"))
    instrument_type_id: Mapped[int] = mapped_column(ForeignKey("master.instrument_type.instrument_type_id"))
